	...
	<div id="w">
		...
		<div class="search">
			<form method="post" action="./list">
				...
				<input type="button" value="등록" onclick="location.href='${pageContext.request.contextPath }/address/create'"/>
			</form>
		</div>
		<table>
			<tr>
		...
		<div class="bottom">
<!-- 			<input type="button" class="button" value="등록" onclick="location.href='./create'"> -->
			${paging }
		</div>
	</div>
</body>
